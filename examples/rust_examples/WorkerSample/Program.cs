    ...
    public static IHostBuilder CreateHostBuilder(string[] args) =>
        Host.CreateDefaultBuilder(args)
            ...
            }).AddRabbitMqWorkerPool(new RabbitMqSetting
            {
                ...
                PrefetchTaskCount = 3
            }, new WorkerPoolSetting() { WorkerUnitCount = 8, CommnadLine = "./worker_dir/ClientSamlpe", Arguments = string.Empty , QueueName = Environment.GetEnvironmentVariable("QUEUENAME"),});
