...
//    {
//        private readonly Mock<ILogger<WorkerPool>> _loggerMock;
//        private readonly Mock<ILoggerFactory> _loggerFactoryMock;
//        private readonly PoolSetting _poolSetting;

//        public ProcessPoolTest()
//        {
//            _loggerMock = new Mock<ILogger<WorkerPool>>();
...
//            processPool.IsClosed.Should().BeTrue();
//        }
...
//            processPool.mockStandardInput.Verify(p => p.WriteLine(WorkerPool.CLOSED_SIGNAL), Times.Exactly(unitCount));
